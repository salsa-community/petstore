package mx.infotec.mascotams.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("mx.infotec.mascotams.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("mx.infotec.mascotams.security.DomainUserDetailsService", "createSpringSecurityUser");
