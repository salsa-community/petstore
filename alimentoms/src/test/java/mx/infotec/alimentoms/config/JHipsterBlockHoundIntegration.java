package mx.infotec.alimentoms.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("mx.infotec.alimentoms.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("mx.infotec.alimentoms.security.DomainUserDetailsService", "createSpringSecurityUser");
